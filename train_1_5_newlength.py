...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.save_dir = 'logs/param_cvMOG2_resnet34_v1b_k400_ucf101_seg8_1'
        ...
        self.input_channel=15 #3
        self.num_segments=8
        self.num_workers = 1
        self.num_gpus = 1
        self.per_device_batch_size = 25
        self.lr = 0.01
        self.lr_decay = 0.1
        self.warmup_lr = 0
        ...
        self.reshape_type = 'tsn_newlength'#'tsn' # c3d tsn tsn_newlength
