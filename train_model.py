...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.use_amp = False
        self.epochs = 100
        self.lr_decay_epoch = [5,30,60, np.inf]#[30,60,80]
        self.dtype = 'float32'
        ...
        self.lr_mode = 'step'
        self.save_dir = 'logs/param_rgb_c3d_scratch_bn'
        self.resume_epoch = 0
        self.resume_params = ''
        self.resume_states = ''
        self.reshape_type = 'c3d' # tsn tsn_newlength
...
#        lr_decay_count += 1
    ...
    logger.info('[Epoch %d] val top1 =%f top5=%f val loss=%f' %
        (epoch, acc_top1_val, acc_top5_val, loss_val ))
    if acc_top1_val > best_val_score and epoch > opt.log_interval:
