...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.use_kinetics_pretrain = True#False
        ...
        self.save_dir = 'logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_hmdb51_nlength16_lateral_scratch_gan_train72'
