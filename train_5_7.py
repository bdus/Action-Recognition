...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.use_kinetics_pretrain = True
        self.TranConv_model = 'r2plus1d_resnet34_tranconv_lateral_tanhbn'
        self.use_lateral=True
        self.freeze_lateral=False #True
        self.save_dir = 'logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_hmdb51_nlength16_lateral_scratch_tanh_T_eq1_lr01_k400'
