...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.freeze_lateral=True
        self.save_dir = 'logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_ucf101_nlength16_lateral_finetune'
        ...
        self.train_patterns = ' r2plus1d0_dense0*'
        self.use_train_patterns = False
        self.freeze_patterns = ''
        self.freeze_lr_mult = 0.001 #set freezed base layer lr = self.lr * self.freeze_lr_mult
        self.use_mult = False
        self.clip_grad = 40
        self.log_interval = 10
        self.lr_mode = 'cosine'#'step'        
        self.resume_epoch = 0
        self.resume_params = os.path.join('logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_ucf101_nlength16_lateral_1','0.9315-ucf101-r2plus1d_resnet18_kinetics400_custom-011-best.params')
        self.resume_states = os.path.join('logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_ucf101_nlength16_lateral_1','0.9315-ucf101-r2plus1d_resnet18_kinetics400_custom-011-best.states')
...
if opt.use_mult:
    net1.collect_params(opt.freeze_patterns).setattr('lr_mult',opt.freeze_lr_mult)
