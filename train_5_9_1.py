...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.save_dir = 'logs/param_rgb_r2plus1d_resnet34_kinetics400_custom_hmdb51_nlength16_lateral_scratch_tanh_pre_train591'
    ...
    for i, batch in enumerate(val_data):
        ...
        if not opt.use_lateral:
            ...
            if opt.predict_T == 0: # normal
                ...
                loss2 = [loss_l2(xhat, takeT(x.astype(opt.dtype, copy=False),T=opt.predict_T)) for xhat, x in zip(l2out,data )]                
