...
class config(AttrDisplay):
    def __init__(self):
        ...
        self.save_dir = 'logs/param_rgb_r2plus1d_resnet18_kinetics400_custom_hmdb51_nlength16_lateral_scratch_tanh_pre_train62'
        ...
        with ag.record():
            ...
            if not opt.use_lateral:
                ...
                if opt.predict_T == 0: # normal
                    ...
                    loss3 = [(loss_l2(f1[2],f2[2]) + 0.1*loss_l2(f1[1],f2[1]) ) for f1, f2 in zip(l2latel,l2latel1) ]
                    loss = [(l0+l1+l2+0.1*l3) for l0, l1, l2, l3 in zip(loss0,loss1,loss2,loss3)]
