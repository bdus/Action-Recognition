...
#net = inception_v3(pretrained=False, partial_bn=True)
...
transform_train = transforms.Compose([
    ...
    video.VideoMultiScaleCrop(size=(299, 299), scale_ratios=[1.0, 0.875, 0.75, 0.66]),
...
train_dataset = ucf101.classification.UCF101(train=True, num_segments=7,transform=transform_train,
                                             ...
                                             new_height=340,new_width=450,new_length=5,                                             
                                             
                                             )

val_dataset = ucf101.classification.UCF101(train=False, num_segments=7, transform=transform_train,
                                             root='/media/hp/data/BGSDecom/PixelBasedAdaptiveSegmenter/fgs',#'/home/hp/lixiaoyu/dataset/flow',
