...
class config(AttrDisplay):
    def __init__(self):
        self.new_length_fgs = 32
        self.new_length_bgs = 32
        self.new_step_fgs= 2
        self.new_step_bgs= 2
        self.fusion_method = 'avg'# avg max bgs fgs
        self.bgsmodel = 'i3d_resnet50_v1_ucf101'#'resnet34_v1b_ucf101'
        self.fgsmodel = 'i3d_resnet50_v1_ucf101'
        self.save_dir = 'logs/test4'
        self.bgs_path = '/home/hp/.mxnet/models'
        self.fgs_path = 'logs/param_cvMOG2_i3d_resnet50_v1_ucf101_seg1nl32ns2'#param_cvMOG2_resnet34_v1b_k400_hmdb51_seg8_1_ucf101pretrained'#param_cvMOG2_resnet34_v1b_k400_ucf101_seg8_1'
        self.bgs_params = os.path.join(self.bgs_path, 'i3d_resnet50_v1_ucf101-760d0981.params')#0.5222-hmdb51-resnet34_v1b_ucf101-013-best.params')#0.5941-hmdb51-resnet34_v1b_ucf101-012-best.params')##'0.9344-ucf101-resnet101_v1b_k400_ucf101-021-best.params')#'0.8655-ucf101-resnet34_v1b_ucf101-059-best.params')#
        self.fgs_params = os.path.join(self.fgs_path, '0.8258-ucf101-i3d_resnet50_v1_ucf101-063-best.params')#0.5340-hmdb51-resnet34_v1b_k400_ucf101-061-best.params')#'0.8097-ucf101-resnet34_v1b_k400_ucf101-049-best.params'
        ...
        self.input_channel_fgs=3
        self.input_channel_bgs=3
        self.num_segments_bgs=1
        self.num_segments_fgs=1        
        self.num_workers = 2
        self.num_gpus = 1
